...
class ModuleController extends Controller
{
    ...
    private function sanitize(string $value): string
    {
        ...
        // If not valid UTF-8, try to convert from Windows-1252 / CP1256
        if (!mb_check_encoding($value, 'UTF-8')) {
            $converted = @mb_convert_encoding($value, 'UTF-8', 'Windows-1256, Windows-1252, ISO-8859-1');
            $value = $converted ?: preg_replace('/[^\x09\x0A\x0D\x20-\x7E]/', '', $value);
        }
